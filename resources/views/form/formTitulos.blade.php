...
<body class="hold-transition layout-top-nav">
    ...
    <div class="content-wrapper">
        ...
        <!-- /.content-header -->
        <form action="{{ route('inscricao.cadastraTitulo') }}" method="POST">
            @csrf
        <!-- Main content -->
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="container-fluid">
                        <div class="card card-info" id="div-escolaridade">
                            <div class="card-header">
                                <h3 class="card-title">Titulos do Candidato </h3>
...
<!-- ./wrapper -->
    ...
    <!--js da pagina -->
    <script src={{asset("/js/pages/TituloSelect.js")}}></script>
    <script src={{asset("/js/pages/print.min.js")}}></script>
</body>
</html>