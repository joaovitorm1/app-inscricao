...
<body class="hold-transition layout-top-nav">
    ...
    <div class="content-wrapper">
        ...
        <!-- /.content-header -->
        <form action="{{ route('inscricao.cadastraRequisito') }}" method="POST">
            @csrf
        <!-- Main content -->
        <div class="content">
            <div class="container">
                    ...
                    <div class="container-fluid">
                        <div class="card card-info">
                            <div class="card-header">
                              <h3 class="card-title">Requisitos do cargo pretendido</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div id="lista-requisitos" class="card-body">
                                <div class="row" onclick="selectTitulo({{ $item->id }})">
                                    <div class="form-group">    
                                        <div class="custom-control custom-switch custom-switch-on-success">     
                                            <input type="checkbox" name="requisitos[]" class="custom-control-input" value="{{ $item->id }}" id="req-{{ $item->id }}">      
                                            <label class="custom-control-label" for="req-{{ $item->id }}">{{ $item->nome }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
