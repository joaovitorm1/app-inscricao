...
@section('titulo-pagina', 'Cadastro de Tipo Cargo')
...
@section('conteudo-principal')
    ...
    @component('components.breadcrumb')
        @slot('subTitulo')
            Formulário de Cadastro de Tipo Cargo
        @endslot
    @endcomponent
                    ...
                    <div class="content-header">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-1">
                                    <button class="btn btn-primary" id="btn-cadastrar-tipo-cargo" title="Adicionar" disabled>Cadastrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
