...
@section('titulo-pagina', 'Cadastro de Local Cargo')
...
@section('conteudo-principal')
    ...
    @component('components.breadcrumb')
        @slot('subTitulo')
            Formulário de Cadastro de Local dos Cargo
        @endslot
    @endcomponent

        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('localCargo.cadastrar.adm') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="content-header">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-1">
                                    <button class="btn btn-primary" id="btn-cadastrar-local" title="Adicionar" disabled>Cadastrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
