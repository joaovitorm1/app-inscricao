...
@section('titulo-pagina', 'Cadastro de Grupo de Usuário')
...
@section('conteudo-principal')
    @component('components.breadcrumb')
        @slot('subTitulo')
            Formulário de Cadastro de Grupo de Usuário
        @endslot
    @endcomponent

        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('grupoUsuario.cadastrar.adm') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="descricao" name="descricao" type="text" class="form-control @error('descricao') is-invalid @enderror" value="{{ old('descricao') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="custom-control custom-switch custom-switch-on-success">
                                                        <input type="checkbox" name="permissoes[]" class="custom-control-input" value="{{ $item->id }}" id="{{ $item->id }}" >
