...
@section('titulo-pagina', 'Editar Grupo Ocupacional')
...
@section('conteudo-principal')
    @component('components.breadcrumb')
        @slot('subTitulo')
            Formulário para Edição de Grupo Ocupacional
        @endslot
    @endcomponent
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input id="id" name="id" type="number" class="form-control @error('id') is-invalid @enderror"  value="{{ $grupo->id }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="nome" name="nome" type="text" class="form-control @error('nome') is-invalid @enderror" value="{{ $grupo->nome }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="content-header">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-1">
                                    <button class="btn btn-primary" id="btn-atualizar-grupoOcupacional" title="Atualizar">Atualizar</button>
                                </div>
                            </div>
                        </div>
                    </div>
