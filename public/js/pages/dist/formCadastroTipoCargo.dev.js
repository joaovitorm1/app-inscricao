...
$('#select-edital').on("change", function selecionaEdital() {
  ...
  if (idEdital != 0) {
    ...
    $("#btn-cadastrar-tipo-cargo").attr("disabled", false);
  } else {
    $("#nome").attr("readonly", true);
    $("#btn-cadastrar-tipo-cargo").attr("disabled", true);
  }
}).change();
/*
*	PARA A ATUALIZAÇÃO 
...
$('#select-edital-atualizar').on("change", function selecionaEdital() {
  ...
  if (idEdital != 0) {
    $("#nome").attr("readonly", false);
    $("#btn-atualizar-tipo-cargo").attr("disabled", false);
  } else {
    $("#nome").attr("readonly", true);
    $("#btn-atualizar-tipo-cargo").attr("disabled", true);
  }
}).change();